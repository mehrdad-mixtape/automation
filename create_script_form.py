...
class Ui_Create_script_Window(object):
    def setupUi(self, Create_script_Window):
        ...
        self.retranslateUi(Create_script_Window)
        QtCore.QMetaObject.connectSlotsByName(Create_script_Window)

    def retranslateUi(self, Create_script_Window):
...
if __name__ == "__main__":
    ...
    ui.setupUi(Create_script_Window)
